...
import { manifest } from './manifest_D4k4GSrs.mjs';
...
const _page7 = () => import('./pages/hello.astro.mjs');
const _page8 = () => import('./pages/ssg.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/hello.astro", _page7],
    ["src/pages/ssg.astro", _page8],
...
const _args = {
    "middlewareSecret": "b09fce5d-55d9-4fe2-b824-30815a63f2b9",
