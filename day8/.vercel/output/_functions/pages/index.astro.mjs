import { a as createComponent, s as spreadAttributes, u as unescapeHTML, e as renderTemplate, c as createAstro, m as maybeRenderHead, b as addAttribute, r as renderHead, i as renderSlot, d as renderComponent } from '../chunks/astro/server_BmAgNbLp.mjs';
import 'kleur/colors';
import 'clsx';
/* empty css                                 */
...
const $$Astro$2 = createAstro("https://astrojs-test-orpin.vercel.app");
...
}, "/home/dirk/DirkData/Astrojs/day8/src/components/Welcome.astro", void 0);

const $$Astro$1 = createAstro("https://astrojs-test-orpin.vercel.app");
...
}, "/home/dirk/DirkData/Astrojs/day8/src/layouts/Layout.astro", void 0);

const $$Astro = createAstro("https://astrojs-test-orpin.vercel.app");
const $$Index = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$Index;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, {}, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<form method="post" action="/api/contact"> <input name="name" placeholder="Tên" required> <input name="email" type="email" placeholder="Email" required> <textarea name="message" placeholder="Lời nhắn..." required></textarea> <button type="submit">Gửi</button> </form> ${renderComponent($$result2, "Welcome", $$Welcome, {})} ` })}`;
}, "/home/dirk/DirkData/Astrojs/day8/src/pages/index.astro", void 0);

const $$file = "/home/dirk/DirkData/Astrojs/day8/src/pages/index.astro";
const $$url = "";
